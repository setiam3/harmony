...
class Orderdetail extends CActiveRecord
{
	...
	public function search(array $columns)
	{
		...
		$criteria->compare('order_id',$_GET['sSearch'],true,'OR');
		$criteria->compare('product_id',$_GET['sSearch'],true,'OR');
		$criteria->compare('qty',$_GET['sSearch'],true,'OR');
		$criteria->compare('subtotal',$_GET['sSearch'],true,'OR');
	}
