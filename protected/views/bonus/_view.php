<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('dari_member')); ?>:</b>
	<?php echo CHtml::encode($data->dari_member); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('idbonus')); ?>:</b>
	<?php echo CHtml::encode($data->idbonus); ?>
	<br />
