	...
	if($column->autoIncrement)
		continue;?>
			array(
        		...
        		'value'=>'CHtml::link($data-><?php echo $column->name;?>,Yii::app()->controller->createUrl("view",array("id"=>$data->id)))',
        		),
<?php
}
?>
	...
	public function actionIndex()
	{
		...
		$widget=$this->createWidget('ext.EDataTables.EDataTables', array(
		 'id'            => '<?php echo $this->modelClass; ?>-grid',
	...
	public function actionAdmin()
	{
		$ar1=array('class'=> 'EButtonColumn',
		    ...
		    'buttons'=>array(
		    	'update'=>array(
		    		'url'=>'Yii::app()->createUrl("<?php echo $this->modelClass; ?>/update/$data->id")',
		    		),
		        'delete' => array(
		        	'url'=>'Yii::app()->createUrl("<?php echo $this->modelClass; ?>/delete/$data->id")',
